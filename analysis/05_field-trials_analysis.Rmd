...
Effect of seed treatment (ST) on stand for multilocation field trials in 2017. Dots represent mean stands at VC and 
vertical lines their confidence interval. Means with an asterick are significantly different. Panels with two asteriks
represent a significant difference in the contrast between the untreated control and the seed treatment.
...
Effect of seed treatment and varieties with no resistance gene (rps), Rps1c or Rps1k on stand count at VC (A) and 
yield (B) in 2018 field trial in Urbana, IL. Dots represent the mean stand of seed treatment (ST) plots and untreated 
control (NTC) plots. Vertical bars show confidence intervals of means. Varieties with a significant difference between
the untreated control and seed treatment are indicated with an asterisk. (C) Box plots of the distribution of yield of
varieties with different levels of partial resistance in 2018 field trial in Urbana, IL. The center lines show the
medians and box limits indicate the 25th and 75th percentiles and whiskers extend 1.5 times the interquartile range
(IQR). Outliers are represented by black solid dots. 
...
map(models.201, resid_panel) #residuals normally distributed and homogenicity of variance
```
